        ...
        <center>
            <div style="width: 900px;padding: 10px;margin: 10px;overflow-x: visible;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="head_data">                   
                    <tr>
                        <td align="center"><h2 style="margin-top: 10px;">TARGET PACKING - <?php echo date('d F Y') ?></h2><br/></td>
                    </tr>                    
                </table>
                <table border='0' width='100%' class="data_table2" cellpadding="0" cellspacing="0" style="margin-top: 5px;">
                    <thead>
                        <tr>
                            ...
                            <th width="50" style="border: 1px black solid;" align="center">PACK SIZE -W-</th>
                            <th width="50" style="border: 1px black solid;" align="center">PACK SIZE -D-</th>
                            <th width="50" style="border: 1px black solid;" align="center">PACK SIZE -H-</th>
                            ...
                            <th width="60" style="border: 1px black solid;" align="center">PACK IN</th>                             
                        ...
                        if (!empty($item)) {
                            ...
                            foreach ($item as $result) {
                                ...
                                <tr>
                                    ...
                                    <td style="border-right: 1px #000 solid"><?php echo $result->packagingsize_mm_w ?></td>
                                    <td style="border-right: 1px #000 solid"><?php echo $result->packagingsize_mm_d ?></td>
                                    <td style="border-right: 1px #000 solid"><?php echo $result->packagingsize_mm_h ?></td>
                                    <td style="border-right: 1px #000 solid" align="center">
                                        <img style="max-height: 100px;max-width: 100px;border:none" src="../../files/model/<?php echo $result->images;?>">
                                    </td>             
                                    <td style="border-right: 1px #000 solid" align="center">
                                        <?php
                                    ...
                                    <td style="border-right: 1px #000 solid" align="center"><?php echo date('d-M-y', strtotime($result->pack_in)); ?>&nbsp;</td>  
                                    <td style="border-right: 1px #000 solid" align="center" style="border-right: 1px #000 solid"><?php echo $result->pack_aging ?></td>
                                    <td style="border-right: 1px #000 solid" align="center" style="border-right: 1px #000 solid"><?php echo $result->qty;
                                $total += $result->qty; ?></td>
                                </tr>
                                <?php
                            }
