        ...
        <center>
            <div style="width: 900px;padding: 10px;margin: 10px;overflow-x: visible;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="head_data">                   
                    <tr>
                        <td align="center"><h2 style="margin-top: 10px;">TARGET CARVING - <?php echo date('d F Y') ?></h2><br/></td>
                    </tr>                    
                </table>
                <table border='0' width='100%' class="data_table2" cellpadding="0" cellspacing="0" style="margin-top: 5px;">
                    <thead>
                        <tr>
                            ...
                            <th width="60" style="border: 1px black solid;" align="center">MC OUT</th>                             
                    ...
                    <tbody>
                        ...
                        if (!empty($item)) {
                            ...
                            foreach ($item as $result) {
                                ...
                                <tr>
                                    ...
                                    <td style="border-right: 1px #000 solid" align="center"><?php echo date('d-M-y', strtotime($result->cv_in)); ?>&nbsp;</td>  
                                    <td style="border-right: 1px #000 solid" align="center"><?php echo $result->cv_aging ?></td>
                        ...
                        <tr style="background: none">
                            <td style="border-top:1px solid #000;" colspan="12">Grand Total</td>
