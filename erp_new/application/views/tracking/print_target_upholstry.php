<html>
    <head>
        <title>Target Upholstery</title>
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/css/print.css">
    </head>
    <body>
        <div style="width: auto;padding: 10px;margin: 10px;overflow-x: visible;">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="head_data">                   
                <tr>
                    <td align="center"><h2 style="margin-top: 10px;">TARGET UPHOLSTERY - <?php echo date('d F Y') ?></h2><br/></td>
                </tr>                    
            </table>
            <table border='0' width='100%' class="data_table2" cellpadding="0" cellspacing="0" style="margin-top: 5px;">
                <thead>
                    <tr>
                        <th width="10" style="border: 1px black solid;">No</th>
                        <th width="60" style="border: 1px black solid;" align="center">EXPECTED DELIVERY DATE</th>                            
                        <th width="20" style="border: 1px black solid;" align="center"><p>CUST OMER</p></th>                          
                        <th width="50" style="border: 1px black solid;" align="center">SUPPLIER</th>
                        ...
                        <th width="150" style="border: 1px black solid;" align="center">FABRIC</th>
                        <th width="150" style="border: 1px black solid;" align="center">MATERIAL</th>                   
                        <th width="60" style="border: 1px black solid;" align="center">FIN OUT</th>                             
                ...
                <tbody>
                    ...
                    if (!empty($item)) {
                        ...
                        foreach ($item as $result) {
                            ...
                            <tr>
                                ...
                                <td style="border-right: 1px #000 solid" align="center">&nbsp;</td>
                                ...
                                <td style="border-right: 1px #000 solid" align="center"><?php echo $result->fabric ?></td>
                                <td style="border-right: 1px #000 solid" align="center">
                                    <?php
                                    echo $result->material;
                                    if(!empty($result->fabric)){
                                        echo ", FABRIC ".$result->fabric;
                                    }if(!empty($result->foam)){
                                        echo ", ".$result->foam;
                                    }if(!empty($result->mirrorglass)){
                                        echo ", ".$result->mirrorglass;
                                    }if(!empty($result->interliner)){
                                        echo ", ".$result->interliner;
                                    }if(!empty($result->top)){
                                        echo ", ".$result->top;
                                    }if(!empty($result->accessories)){
                                        echo ", ".$result->accessories;
                                    }
                                    ?>
                                </td>
                                <td style="border-right: 1px #000 solid" align="center"><?php echo date('d-M-y', strtotime($result->up_in)); ?>&nbsp;</td>                        
                                <td style="border-right: 1px #000 solid" align="center"><?php echo $result->up_aging ?>&nbsp;</td>
                                <td style="border-right: 1px #000 solid" align="center" style="border-right: 1px #000 solid">
                                    <?php
                                    echo $result->qty;
                                    $total += $result->qty;
                                    ?>
                    ...
                    <tr style="background: none">
                        <td style="border-top:1px solid #000;" colspan="15">Grand Total</td>
