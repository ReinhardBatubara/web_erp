<html>
    <head>
        <title>Detail Stock In Report</title>
        ...
        <center>
            <div style="width: 850px;border: 1px #000 dashed;padding: 10px;margin: 10px;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="head_data">
                    ...
                    <tr>
                        <td align="center"><h2 style="margin-top: 10px;">DETAIL STOCK IN REPORT</h2><br/></td>
                    </tr>
                    <tr>
                        <td>
                            <span class="data_label">Period :</span> <?php echo date('d-m-Y', strtotime($datefrom)) . " s/d " . date('d-m-Y', strtotime($dateto)) ?>
                        </td>
                    </tr>
                </table>
                <table border='0' width='100%' class="data_table" cellpadding="0" cellspacing="0" style="margin-top: 5px;">
                    <thead>
                        <tr>
                            ...
                            <th width="10%" style="border: 1px black solid;" align="center">GR / BPNP</th>
                            <th width="8%" style="border: 1px black solid;" align="center">Date</th>
                            ...
                            <th width="8%" style="border: 1px black solid;" align="center">Store To</th>
                            <th width="17%" style="border: 1px black solid;" align="center">Supplier</th>                            
                            <th width="10%" style="border: 1px black solid;" align="center">Remark</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        if (!empty($item)) {
                            ...
                            foreach ($item as $result) {
                                ...
                                <tr>
                                    ...
                                    <td style="border-right: 1px #000 solid" align="center"><?php echo $result->stock_in_number ?></td>
                                    ...
                                    <td style="border-right: 1px #000 solid" align="center"><?php echo $result->store_to ?></td>
                                    <td style="border-right: 1px #000 solid" ><?php echo $result->vendor_name ?></td>
                                    <td style="border-right: 1px #000 solid" style="border-right: 1px #000 solid"><?php echo $result->remark ?></td>
                                </tr>
                                <?php
                            }
                        } else {
