...
<table id="bank" data-options="
    ...
    <thead>
        <tr>
            ...
            <th field="branch" width="200" halign="center" sortable="true">Branch</th>
            <th field="city" width="200" halign="center" sortable="true">City</th>
            <th field="swift" width="200" halign="center" sortable="true">Swift</th>
            <th field="rtgs" width="200" halign="center" sortable="true">RTGS</th>
        </tr>
    </thead>
</table>
