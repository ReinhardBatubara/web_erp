...
<div style="width: 750px;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0">                    
        <tr>
            <td  align="center" style="padding: 15px 0px 15px 0px">
                <span style="font-size: 16px;font-weight: bold;font-family: Helvetica,Tahoma">BUKTI PERNERIMAAN BARANG</span>
            </td>
        </tr>
        <tr valign="top">
            <td>
                <table width="100%" class="mydatatabel">
                    <tr>
                        <td width="25%" class="data_label">BPnB No</td>
                        <td width="1%" align="center">:</td>
                        <td width="74%"><?php echo $stock_in->bpnp ?></td>
                    </tr>
                    <tr>
                        <td class="data_label">BPnB Date</td>
                        <td>:</td>
                        <td><?php echo date('d/m/Y', strtotime($stock_in->date)); ?></td>
                    </tr>
                    <tr>
                        <td class="data_label">Supplier</td>
                        <td>:</td>
                        <td><?php echo $stock_in->vendor ?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table border='0' width='100%' class="mydatatabel" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
        ...
        <tbody>
            <?php
            $count = 10;
            if (!empty($stock_in_detail)) {
                $no = 1;
                foreach ($stock_in_detail as $result) {
                    ?>
                    <tr>
            ...
            <tr valign="top">
                ...
                <td colspan="4" style="border-bottom: 1px #000 solid;padding:5px;"><?php echo $stock_in->remark ?>&nbsp;</td>
            </tr>
            <tr>
                <td colspan="6"><br/></td>
            </tr>
    ...
    <table width="100%" border="0" class="mydatatabel">
        <tr valign="top">
            <td align="center" width="25%">
                ...
                <?php echo $stock_in->employee_receive ?><br/>
            ...
            <td align="center" width="25%">
                <b>The Price Given By</b><br/><br/><br/>
                <br/>
                <hr style="border: 0; height: 1px; background: #333; width: 80%" /> 
                Buyer
            </td>
