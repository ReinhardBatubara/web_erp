<div id="costing-form" class="easyui-dialog" 
    ...
    <form id="costing-input" method="post" novalidate class="table_form">
        <table width="100%" border="0">
            <tr>
                <td align="right" width="45%"><label class="field_label">Date  :</label></td>
                <td><input type="tex" class="easyui-datebox" name="date" id="date" size="12" required="true" data-options="formatter:myformatter,parser:myparser"/></td>
            </tr>
            <tr>
                    ...
                    <script>
                        $('#modelid').combogrid({
                            ...
                            columns: [[
                                    ...
                                    {field: 'originalcode', title: 'Original Code', width: 120, rowspan: 2},
                                    {field: 'name', title: 'Item Name', width: 100, rowspan: 2},
                                    {field: 'mastercode', title: 'Master Code', width: 100, rowspan: 2},
                                    {field: 'code', title: 'Item Code', width: 100, rowspan: 2},
                                    {title: 'Item Code', width: 100, colspan: 3},
            ...
            <tr>
                ...
                <td><input type="tex" class="easyui-numberbox" name="labour_cost_percentage" id="labour_cost_percentage" precision="0" required="true" style="width: 30px;text-align: center;"/> %</td>
            </tr>
            <tr>
                <td align="right"><label class="field_label">X FACTOR Percentage :</label></td>
                <td><input type="tex" class="easyui-numberbox" name="xfactor_percentage" id="xfactor_percentage" precision="0" required="true" style="width: 30px;text-align: center;"/> %</td>
            </tr>
            <tr>
                <td align="right"><label class="field_label">Overhead Percentage :</label></td>
                <td><input type="tex" class="easyui-numberbox" name="overhead_percentage" id="overhead_percentage" precision="0" required="true" style="width: 30px;text-align: center;"/> %</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="tex" class="easyui-numberbox" name="margin_percentage" id="margin_percentage" precision="0" required="true" style="width: 30px;text-align: center;"/> %</td>
            </tr>
            <tr>
                <td align="right"><label class="field_label">Selling Price Percentage:</label></td>
                <td><input type="tex" class="easyui-numberbox" name="selling_price_percentage" id="selling_price_percentage" precision="0" required="true" style="width: 30px;text-align: center;"/> %</td>
            </tr>
        </table>        
    </form>
</div>
