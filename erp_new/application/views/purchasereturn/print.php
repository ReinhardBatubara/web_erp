        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">                    
            <tr>
                <td  align="center" style="padding: 15px 0px 15px 0px">
                    <span style="font-size: 16px;font-weight: bold;font-family: Helvetica,Tahoma">RETURN To SUPPLIER / PURCHASED RETURN</span>
                </td>
            </tr>
            <tr valign="top">
                <td>
                    <table width="50%" class="mydatatabel">
                        <tr>
                            ...
                            <td width="74%"><?php echo $prt->number ?></td>
                        </tr>
                        <tr>
                            <td><strong>Date</strong></td>
                            <td>:</td>
                            <td><?php echo date('d/m/Y', strtotime($prt->date)) ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table border='0' width='100%' class="mydatatabel" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
            ...
            <tbody>
                ...
                <tr valign="top">
                    ...
                    <td colspan="4" style="border-bottom: 1px #000 solid;padding:5px;"><?php echo $prt->remark ?>&nbsp;</td>
                </tr>
            </tbody>
        </table>
        <br/>
