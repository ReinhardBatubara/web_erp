<div style="height: 500px">
    <div id="mrp_list_to_request-toolbar" style="padding-bottom: 2px;">
        ...
        <input type="text" 
               ...
               onkeyup="if (event.keyCode === 13) {materialrequisition_from_mrp_searchfordialog();}" 
               />    
        Description : 
        <input type="text" 
               size="20" 
               ...
               onkeyup="if (event.keyCode === 13) {materialrequisition_from_mrp_searchfordialog();}"
               />
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="materialrequisition_from_mrp_searchfordialog()">Search</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-pointer" plain="true" onclick="materialrequisitiondetail_set_selected_from_mrp()">Set Selected</a>  
    </div>
    <table id="mrp_list_to_request" data-options="
        ...
        <thead>
            <tr>
                ...
                <th field="ots_requisition" width="50" halign="center" align="right">Outstanding Qty</th>
            </tr>
        </thead>
    </table>
