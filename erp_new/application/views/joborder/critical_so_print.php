<html>
    <head>
        <title>Print Critical Sales Order</title>
                    ...
                    <table class="data_table">
                        <thead>
                            <tr>
                                ...
                                <th width="80" rowspan="2">Expected Ship Date</th>
                            ...
                            if (!empty($product)) {
                                ...
                                foreach ($product as $result) {
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><?php echo date('d/mY',  strtotime($result->expected_ship_date));?></td>
                                        ...
                                        <td><?php echo "<b>".$result->customer_code."</b><br/>".$result->customer_name;?></td>
