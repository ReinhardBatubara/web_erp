<div id="critical_order_toolbar" style="padding-bottom: 0px;">
    <form id="critical_so_search_form" onsubmit="critical_so_search();
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="critical_so_search()"></a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="critical_so_print()">Print</a>
    </form>
</div>
<table id="critical_order" data-options="
       url:'<?php echo site_url('tracking/get_critical_order') ?>',
       method:'post',
       title:'Critical Sales Order',
       border:true,
       singleSelect:false,
       fit:true,
       pageSize:50,
